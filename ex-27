...
class employee{
    ...
    string name;
    float salary;
//Member function defined inside inside the class
void setemployee(int id,string n,float s){
    empID=id;
    name=n;
    salary=s;
}
//Member function declaratiom (to be defined outside)
...
int main(){
    employee e1,e2;
    //call function defined inside the class
    e1.setemployee(101,"Ravi",50000.75);
    e2.setemployee(102,"Priya",62000.50);
    //call function defined outside the class
    e1.displayemployee();
    e2.displayemployee();
    return 0;
}
